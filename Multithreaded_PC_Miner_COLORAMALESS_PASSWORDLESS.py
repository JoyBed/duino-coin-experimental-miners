...
if __name__ == '__main__':
    ...
    if arguments <= 2:
        print(bcolors.red + "Provide username and thread count!" + bcolors.endc)
        print(bcolors.yellow + "Example: python3 Multithreaded_PC_Miner.py username 4" + bcolors.endc)
